...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = ArrayAdapter.createFromResource(this, R.array.farm, android.R.layout.simple_spinner_dropdown_item);
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String userFarm = spinner.getSelectedItem().toString();
                ...
                if(userID.equals("") || userPassword.equals("") || userFarm.equals("") || userEmail.equals("") || userGender.equals("")){
                    AlertDialog.Builder builder = new AlertDialog.Builder(RegisterActivity.this);
                ...
                RegisterRequest registerRequest = new RegisterRequest(userID, userPassword, userGender, userFarm, userEmail, responseListener);
                RequestQueue queue = Volley.newRequestQueue(RegisterActivity.this);
